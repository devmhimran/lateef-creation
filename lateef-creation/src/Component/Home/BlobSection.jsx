        ...
        <div className='blob__main py-16 lg:py-20 mx-3 lg:mx-0'>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                <div className="blob__card border border-[#3E3E3E] py-24 px-4 hover:bg-black hover:border-black ease-in-out duration-500 lg:hover:-translate-y-5 relative">
                    ...
                    <Link to='/category/website-uiux' className='bg-white text-black px-4 py-2 font-bold mx-auto explore__btn hidden duration-500 absolute'>Explore</Link>
                </div>
                <div className="blob__card border border-[#3E3E3E] py-24 px-4 hover:bg-black hover:border-black ease-in-out duration-500 lg:hover:-translate-y-5 relative">
                    ...
                    <Link to='/category/app-uiux' className='bg-white text-black px-4 py-2 font-bold mx-auto explore__btn hidden duration-500 absolute'>Explore</Link>
                </div>
                <div className="blob__card border border-[#3E3E3E] py-24 px-4 hover:bg-black hover:border-black ease-in-out duration-500 lg:hover:-translate-y-5 relative">
                    ...
                    <Link to='/category/creative-logo-design' className='bg-white text-black px-4 py-2 font-bold mx-auto explore__btn hidden duration-500 absolute'>Explore</Link>
                </div>
                <div className="blob__card border border-[#3E3E3E] py-24 px-4 hover:bg-black hover:border-black ease-in-out duration-500 lg:hover:-translate-y-5 relative">
                    ...
                    <Link to='/category/creative-Illustration-design' className='bg-white text-black px-4 py-2 font-bold mx-auto explore__btn hidden duration-500 absolute'>Explore</Link>
                </div>
            </div>
        </div>
    );
