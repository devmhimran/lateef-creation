    ...
    return (
        <div className="container mx-auto max-w-screen-xl text-center">
            <div className="single__portfolio__detail">
                <h1 className='text-3xl lg:text-5xl text-white mx-0 lg:mx-80 leading-tight'>{name}</h1>
            ...
            <div className="single__portfolio__preview__image mt-11">
                {
                    previewImage.map(imageData => <img className='w-10/12 mx-auto' src={imageData} alt="" />)
                }
            </div>
        </div>
    );
